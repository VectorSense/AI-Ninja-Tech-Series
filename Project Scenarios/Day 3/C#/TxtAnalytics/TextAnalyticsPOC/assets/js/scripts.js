...
jQuery(document).ready(function($) {
  ...
  $("nav select").change(function () {
    var nav_option_id=$(this).find("option:selected").val();
    var get_id_lower=nav_option_id.charAt(0).toLowerCase() + nav_option_id.slice(1);
    var get_id=get_id_lower.replace(/ /g,"_");
    var get_id_append=get_id+"_main";
    if(get_id_append=="vision_main")
    {
      $('#main').hide();
    $('#vision_sec').show();
    $('#feedback').hide();
    ...
    if(get_id_append=="feedback_main")
    {
     $('#main').hide();
    $('#vision_sec').hide();
    $('#feedback').show();
    ...
    if(get_id_append=="language_main")
    {
     $('#main').hide();
    $('#vision_sec').hide();
    $('#feedback').hide();
