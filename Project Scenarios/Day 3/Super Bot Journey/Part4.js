...
bot.dialog('DiscoverPersonality', [
    function (session, args, next) {
            session.send("Discover Personality Intent encountered...");
            session.endDialog();
    }
]).triggerAction({
    matches: 'Discover'
...
// Booking bot
bot.dialog('/ProcrastinateReporting', [
    function (session, args, next) {
        session.send("ProcrastinateReporting encountered...");
        session.endDialog();
    }
]).triggerAction({
    matches: 'ProcrastinateReporting'
});
