...
var handleSlimScroll = function() {
    ...
    $(".sidebar").bind("click touchstart", function(b) {
        ...
        0 === $(b.target).closest(".sidebar").length && (a = !1), b.isPropagationStopped() || a === !0 || ($("#page-container").hasClass("page-sidebar-toggled") && (a = !0, 
        ...
        d = $(window).width() < 979 ? "page-right-sidebar-toggled" : d, $(c).hasClass(d) ? $(c).removeClass(d) : a !== !0 ? $(c).addClass(d) : a = !1, 
    ...
    $("[data-click=sidebar-minify]").click(function(a) {
        ...
        $('#sidebar [data-scrollbar="true"]').css("margin-top", "0"), $('#sidebar [data-scrollbar="true"]').removeAttr("data-init"), 
        $("#sidebar [data-scrollbar=true]").stop(), $(c).hasClass(b) ? ($(c).removeClass(b), 
        $(c).hasClass("page-sidebar-fixed") ? (0 !== $("#sidebar .slimScrollDiv").length && ($('#sidebar [data-scrollbar="true"]').slimScroll({
            destroy: !0
        }), $('#sidebar [data-scrollbar="true"]').removeAttr("style")), generateSlimScroll($('#sidebar [data-scrollbar="true"]')), 
        $("#sidebar [data-scrollbar=true]").trigger("mouseover")) : /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (0 !== $("#sidebar .slimScrollDiv").length && ($('#sidebar [data-scrollbar="true"]').slimScroll({
            destroy: !0
        }), $('#sidebar [data-scrollbar="true"]').removeAttr("style")), generateSlimScroll($('#sidebar [data-scrollbar="true"]')))) : ($(c).addClass(b), 
        ...
        $('#sidebar [data-scrollbar="true"]').css("overflow", "visible")) : ($(c).hasClass("page-sidebar-fixed") && ($('#sidebar [data-scrollbar="true"]').slimScroll({
            destroy: !0
    ...
    "use strict";
    return panelActionRunning ? !1 : (panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function(a) {
        $(this).tooltip({
            title: "Remove",
            placement: "bottom",
            trigger: "hover",
    ...
    $('[name=sidebar-styling] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("header-styling") && 0 !== $(".header").length && "navbar-inverse" == $.cookie("header-styling") && ($(".header").addClass("navbar-inverse"), 
    $('[name=header-styling] option[value="2"]').prop("selected", !0)), $.cookie && $.cookie("content-gradient") && 0 !== $("#page-container").length && "enabled" == $.cookie("content-gradient") && ($("#page-container").addClass("gradient-enabled"), 
    ...
    $('[name=content-styling] option[value="2"]').prop("selected", !0)), $(".theme-list [data-theme]").click(function() {
        ...
        $("#theme").attr("href", a), $(".theme-list [data-theme]").not(this).closest("li").removeClass("active"), 
        $(this).closest("li").addClass("active"), $.cookie("theme", $(this).attr("data-theme"));
    }), $(".theme-panel [name=header-styling]").on("change", function() {
        var a = 1 == $(this).val() ? "navbar-default" : "navbar-inverse", b = 1 == $(this).val() ? "navbar-inverse" : "navbar-default";
        $("#header").removeClass(b).addClass(a), $.cookie("header-styling", a);
    }), $(".theme-panel [name=sidebar-styling]").on("change", function() {
        2 == $(this).val() ? ($("#sidebar").addClass("sidebar-grid"), $.cookie("sidebar-styling", "grid")) : ($("#sidebar").removeClass("sidebar-grid"), 
        $.cookie("sidebar-styling", "default"));
    }), $(".theme-panel [name=content-gradient]").on("change", function() {
        2 == $(this).val() ? ($("#page-container").addClass("gradient-enabled"), $.cookie("content-gradient", "enabled")) : ($("#page-container").removeClass("gradient-enabled"), 
        $.cookie("content-gradient", "disabled"));
    }), $(document).on("change", ".theme-panel [name=content-styling]", function() {
        2 == $(this).val() ? ($("body").addClass("flat-black"), $.cookie("content-styling", "black")) : ($("body").removeClass("flat-black"), 
        ...
        $('.theme-panel [name=header-fixed] option[value="1"]').prop("selected", !0), $("#header").addClass("navbar-fixed-top"), 
        $("#page-container").addClass("page-header-fixed")), $("#page-container").addClass("page-sidebar-fixed"), 
        ...
        $('.theme-panel [name=sidebar-fixed] option[value="2"]').prop("selected", !0), $("#page-container").removeClass("page-sidebar-fixed"), 
    ...
    function a(a, b) {
        var c = (parseInt($(a).css("margin-left")), $(a).width()), d = $(a).find("li.active").width(), e = b > -1 ? b : 150, f = 0;
        if ($(a).find("li.active").prevAll().each(function() {
            ...
            var g = d - c;
            f != d && (g += 40), $(a).find(".nav.nav-tabs").animate({
                marginLeft: "-" + g + "px"
            }, e);
        }
        d != f && f >= c ? $(a).addClass("overflow-right") : $(a).removeClass("overflow-right"), 
        d >= c && f >= c ? $(a).addClass("overflow-left") : $(a).removeClass("overflow-left");
    }
    function b(a, b) {
        var c = $(a).closest(".tab-overflow"), d = parseInt($(c).find(".nav.nav-tabs").css("margin-left")), e = $(c).width(), f = 0, g = 0;
        switch ($(c).find("li").each(function() {
            $(this).hasClass("next-button") || $(this).hasClass("prev-button") || (f += $(this).width());
        }), b) {
          case "next":
            var h = f + d - e;
            e >= h ? (g = h - d, setTimeout(function() {
          ...
          case "prev":
            var h = -d;
            e >= h ? ($(c).removeClass("overflow-left"), g = 0) : g = h - e + 80, $(c).find(".nav.nav-tabs").animate({
                marginLeft: "-" + g + "px"
            }, 150, function() {
    ...
    $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function(b) {
        ...
        var c = $(this).closest("[data-scrollbar=true]"), d = $(window).height(), e = parseInt($("#sidebar").css("padding-top")), f = $("#sidebar").height();
        a = $(c).css("margin-top");
        var g = e;
    ...
    "use strict";
    function a(a, b) {
        var c = $(a).closest(".nav"), d = parseInt($(c).css("margin-left")), e = $(".top-menu").width() - 88, f = 0, g = 0;
        switch ($(c).find("li").each(function() {
            $(this).hasClass("menu-control") || (f += $(this).width());
        }), b) {
          case "next":
            var h = f + d - e;
            e >= h ? (g = h - d + 128, setTimeout(function() {
          ...
          case "prev":
            var h = -d;
            e >= h ? ($(c).find(".menu-control.menu-control-left").removeClass("show"), g = 0) : g = h - e + 88, 
            $(c).animate({
                marginLeft: "-" + g + "px"
            }, 150, function() {
    ...
    function b() {
        var a = $(".top-menu .nav"), b = $(".top-menu .nav > li"), c = $(".top-menu .nav > li.active"), d = $(".top-menu"), e = (parseInt($(a).css("margin-left")), 
        $(d).width() - 128), f = $(".top-menu .nav > li.active").width(), g = 0, h = 0;
        ...
        f != h && h >= e ? $(a).find(".menu-control.menu-control-right").addClass("show") : $(a).find(".menu-control.menu-control-right").removeClass("show"), 
        f >= e && h >= e ? $(a).find(".menu-control.menu-control-left").addClass("show") : $(a).find(".menu-control.menu-control-left").removeClass("show");
    }
    ...
    return {
        init: function() {
            this.initLocalStorage(), this.initSidebar(), this.initTopMenu(), this.initPageLoad(), 
        ...
        initComponent: function() {
            handleDraggablePanel(), handleIEFullHeightContent(), handleSlimScroll(), handleUnlimitedTabsRender(), 
