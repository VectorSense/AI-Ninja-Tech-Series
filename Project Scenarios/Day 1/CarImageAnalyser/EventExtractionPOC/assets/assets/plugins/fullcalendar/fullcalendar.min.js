!function(a) {
    ...
    function d(b) {
        ...
        return a.each(b, function(b, e) {
            "views" != b && (a.isPlainObject(e) && !/(time|duration|interval)$/i.test(b) && -1 == a.inArray(b, Rb) ? (c = null, 
            a.each(e, function(a, e) {
                /^(month|week|day|default|basic(Week|Day)?|agenda(Week|Day)?)$/.test(a) ? (d.views[a] || (d.views[a] = {}), 
                d.views[a][b] = e) : (c || (c = {}), c[a] = e);
            }), c && (d[b] = c)) : d[b] = e);
        }), d;
    }
    function e(a, b) {
    ...
    function l(a, b) {
        return a.height(b).addClass("fc-scroller"), a[0].scrollHeight - 1 > a[0].clientHeight ? !0 : (m(a), 
        !1);
    }
    function m(a) {
    ...
    function A(b) {
        ...
        c = 0; c < f.length; c++) d = f[c], "string" == typeof d ? e.push("-" == d.charAt(0) ? {
            field: d.substring(1),
            order: -1
        } : {
            field: d,
    ...
    function E(a, b) {
        ...
        return h > i && j > g ? (g >= i ? (c = g.clone(), e = !0) : (c = i.clone(), e = !1), 
    ...
    function I(a, b) {
        var c, d, e;
        for (c = 0; c < Ub.length && (d = Ub[c], e = J(d, a, b), !(e >= 1 && bb(e))); c++) ;
        return d;
    }
    function J(a, c, d) {
    ...
    function K(a, b, c) {
        var d;
        return N(c) ? (b - a) / c : (d = c.asMonths(), Math.abs(d) >= 1 && bb(d) ? b.diff(a, "months", !0) / d : b.diff(a, "days", !0) / c.asDays());
    }
    function L(a, b) {
        var c, d;
        return N(a) || N(b) ? a / b : (c = a.asMonths(), d = b.asMonths(), Math.abs(c) >= 1 && bb(c) && Math.abs(d) >= 1 && bb(d) ? c / d : a.asDays() / b.asDays());
    }
    function M(a, c) {
        var d;
        return N(a) ? b.duration(a * c) : (d = a.asMonths(), Math.abs(d) >= 1 && bb(d) ? b.duration({
            months: d * c
        }) : b.duration({
            days: a.asDays() * c
        }));
    ...
    function eb(c, d, e) {
        ...
        return b.isMoment(j) ? (i = b.apply(null, c), gb(j, i)) : O(j) || void 0 === j ? i = b.apply(null, c) : (f = !1, 
        g = !1, k ? Zb.test(j) ? (j += "-01", c = [ j ], f = !0, g = !0) : (h = $b.exec(j)) && (f = !h[5], 
        g = !0) : a.isArray(j) && (g = !0), i = d || f ? b.utc.apply(b, c) : b.apply(null, c), 
        f ? (i._ambigTime = !0, i._ambigZone = !0) : e && (g ? i._ambigZone = !0 : k && (i.utcOffset ? i.utcOffset(j) : i.zone(j)))), 
        i._fullCalendar = !0, i;
    }
    function fb(a, c) {
        var d, e, f = !1, g = !1, h = a.length, i = [];
        for (d = 0; h > d; d++) e = a[d], b.isMoment(e) || (e = Pb.moment.parseZone(e)), 
        f = f || e._ambigTime, g = g || e._ambigZone, i.push(e);
    ...
    function kb(a, b) {
        var c, d = "";
        for (c = 0; c < b.length; c++) d += lb(a, b[c]);
        return d;
    }
    function lb(a, b) {
        var c, d;
        return "string" == typeof b ? b : (c = b.token) ? bc[c] ? bc[c](a) : ib(a, c) : b.maybe && (d = kb(a, b.maybe), 
        d.match(/[1-9]/)) ? d : "";
    }
    function mb(a, b, c, d, e) {
        var f;
        return a = Pb.moment.parseZone(a), b = Pb.moment.parseZone(b), f = (a.localeData || a.lang).call(a), 
        c = f.longDateFormat(c) || c, d = d || " - ", nb(a, b, pb(c), d, e);
    }
    function nb(a, b, c, d, e) {
        var f, g, h, i, j = a.clone().stripZone(), k = b.clone().stripZone(), l = "", m = "", n = "", o = "", p = "";
        for (g = 0; g < c.length && (f = ob(a, b, j, k, c[g]), f !== !1); g++) l += f;
        for (h = c.length - 1; h > g && (f = ob(a, b, j, k, c[h]), f !== !1); h--) m = f + m;
        for (i = g; h >= i; i++) n += lb(a, c[i]), o += lb(b, c[i]);
        return (n || o) && (p = e ? o + d + n : n + d + o), l + p + m;
    }
    function ob(a, b, c, d, e) {
        var f, g;
        return "string" == typeof e ? e : (f = e.token) && (g = cc[f.charAt(0)], g && c.isSame(d, g)) ? ib(a, f) : !1;
    }
    function pb(a) {
        return a in dc ? dc[a] : dc[a] = qb(a);
    }
    function qb(a) {
    ...
    function sb(a, b) {
        ...
        }), c.prototype = R(a.prototype), S(b, c.prototype), T(b, c.prototype), S(a, c), 
        c;
    }
    function tb(a, b) {
    ...
    function ub(a, b) {
        return a || b ? a && b ? a.component === b.component && vb(a, b) && vb(b, a) : !1 : !0;
    }
    function vb(a, b) {
    ...
    function xb(a) {
        return "inverse-background" === yb(a);
    }
    function yb(a) {
    ...
    function Bb(c) {
        var d, e, f, g, h = Pb.dataAttrPrefix;
        return h && (h += "-"), d = c.data(h + "event") || null, d && (d = "object" == typeof d ? a.extend({}, d) : {}, 
        e = d.start, null == e && (e = d.time), f = d.duration, g = d.stick, delete d.start, 
        delete d.time, delete d.duration, delete d.stick), null == e && (e = c.data(h + "start")), 
        null == e && (e = c.data(h + "time")), null == f && (f = c.data(h + "duration")), 
        null == g && (g = c.data(h + "stick")), e = null != e ? b.duration(e) : null, f = null != f ? b.duration(f) : null, 
        g = Boolean(g), {
            eventProps: d,
            startTime: e,
            duration: f,
    ...
    function Eb(a) {
        ...
        for (b = 0; b < a.length; b++) {
            for (c = a[b], d = 0; d < e.length && Hb(c, e[d]).length; d++) ;
    ...
    function Fb(a) {
        ...
        e.forwardSegs = [], f = b + 1; f < a.length; f++) Hb(e, a[f], e.forwardSegs);
    }
    function Gb(a) {
        var b, c, d = a.forwardSegs, e = 0;
        if (void 0 === a.forwardPressure) {
            for (b = 0; b < d.length; b++) c = d[b], Gb(c), e = Math.max(e, 1 + c.forwardPressure);
            a.forwardPressure = e;
        }
    }
    function Hb(a, b, c) {
        c = c || [];
        for (var d = 0; d < b.length; d++) Ib(a, b[d]) && c.push(b[d]);
        return c;
    }
    function Ib(a, b) {
    ...
    function Jb(c, d) {
        ...
        function f() {
            V = O.theme ? "ui" : "fc", c.addClass("fc"), O.isRTL ? c.addClass("fc-rtl") : c.addClass("fc-ltr"), 
            O.theme ? c.addClass("ui-widget") : c.addClass("fc-unthemed"), U = a("<div class='fc-view-container'/>").prependTo(c), 
            S = N.header = new Mb(N, O), T = S.render(), T && c.prepend(T), i(O.defaultView), 
            O.handleWindowResize && (Y = db(m, O.windowResizeDelay), a(window).resize(Y));
        }
        function g() {
            W && W.removeElement(), S.removeElement(), U.remove(), c.removeClass("fc fc-ltr fc-rtl fc-unthemed ui-widget"), 
        ...
        function i(b) {
            cb++, W && b && W.type !== b && (S.deactivateButton(W.type), H(), W.removeElement(), 
            W = N.view = null), !W && b && (W = N.view = bb[b] || (bb[b] = N.instantiateView(b)), 
            W.setElement(a("<div class='fc-view fc-" + b + "-view' />").appendTo(U)), S.activateButton(b)), 
            W && (Z = W.massageCurrentDate(Z), W.displaying && Z.isWithin(W.intervalStart, W.intervalEnd) || h() && (W.display(Z), 
            I(), u(), v(), q())), I(), cb--;
        }
        function j(a) {
            return h() ? (a && l(), cb++, W.updateSize(!0), cb--, !0) : void 0;
        }
        function k() {
            h() && l();
        }
        ...
        function m(a) {
            !cb && a.target === window && W.start && j(!0) && W.trigger("windowResize", ab);
        }
        function n() {
            p(), r();
        }
        function o() {
            h() && (H(), W.displayEvents(eb), I());
        }
        function p() {
            H(), W.clearEvents(), I();
        }
        ...
        function M(a, b) {
            ...
            return b = b || ab, this.triggerWith(a, b, c), O[a] ? O[a].apply(b, c) : void 0;
        }
        var N = this;
        N.initOptions(d || {});
        var O = this.options;
        N.render = e, N.destroy = g, N.refetchEvents = n, N.reportEvents = s, N.reportEventChange = t, 
        N.rerenderEvents = o, N.changeView = i, N.select = w, N.unselect = x, N.prev = y, 
        N.next = z, N.prevYear = A, N.nextYear = B, N.today = C, N.gotoDate = D, N.incrementDate = E, 
        N.zoomTo = F, N.getDate = G, N.getCalendar = J, N.getView = K, N.option = L, N.trigger = M;
        var P = R(Lb(O.lang));
        if (O.monthNames && (P._months = O.monthNames), O.monthNamesShort && (P._monthsShort = O.monthNamesShort), 
        O.dayNames && (P._weekdays = O.dayNames), O.dayNamesShort && (P._weekdaysShort = O.dayNamesShort), 
        null != O.firstDay) {
            var Q = R(P._week);
        ...
        }(O.weekNumberCalculation), N.defaultAllDayEventDuration = b.duration(O.defaultAllDayEventDuration), 
        N.defaultTimedEventDuration = b.duration(O.defaultTimedEventDuration), N.moment = function() {
            var a;
            return "local" === O.timezone ? (a = Pb.moment.apply(null, arguments), a.hasTime() && a.local()) : a = "UTC" === O.timezone ? Pb.moment.utc.apply(null, arguments) : Pb.moment.parseZone.apply(null, arguments), 
            "_locale" in a ? a._locale = P : a._lang = P, a;
            ...
            N.getIsAmbigTimezone() && c.stripZone(), c;
        }, N.humanizeDuration = function(a) {
            return (a.locale || a.lang).call(a, O.lang).humanize();
        }, Nb.call(N, O);
        var S, T, U, V, W, X, Y, Z, $ = N.isFetchNeeded, _ = N.fetchEvents, ab = c[0], bb = {}, cb = 0, eb = [];
    ...
    function Mb(b, c) {
            ...
            return f && a.each(f.split(" "), function(d) {
                ...
                a.each(this.split(","), function(d, e) {
                    ...
                    "title" == e ? (g = g.add(a("<h2>&nbsp;</h2>")), h = !1) : ((f = (b.options.customButtons || {})[e]) ? (j = function(a) {
                        ...
                        b[e]();
                    }, k = (b.overrides.buttonText || {})[e], l = c.buttonText[e]), j && (m = f ? f.themeIcon : c.themeButtonIcons[e], 
                    o = f ? f.icon : c.buttonIcons[e], q = k ? Y(k) : m && c.theme ? "<span class='ui-icon ui-icon-" + m + "'></span>" : o && !c.theme ? "<span class='fc-icon fc-icon-" + o + "'></span>" : Y(l), 
                    r = [ "fc-" + e + "-button", n + "-button", n + "-state-default" ], s = a('<button type="button" class="' + r.join(" ") + '">' + q + "</button>").click(function(a) {
                ...
                g.length > 1 ? (f = a("<div/>"), h && f.addClass("fc-button-group"), f.append(g), 
        ...
        var m = this;
        m.render = d, m.removeElement = e, m.updateTitle = g, m.activateButton = h, m.deactivateButton = i, 
        m.disableButton = j, m.enableButton = k, m.getViewsWithButtons = l;
        var n, o = a(), p = [];
    }
    function Nb(c) {
        function d(a, b) {
        ...
        function g(b, d) {
            ...
            if (i) a.isFunction(i) ? (K.pushLoading(), i.call(K, L.clone(), M.clone(), c.timezone, function(a) {
                ...
                if (j) {
                    ...
                    p && (o[p] = L.format()), q && (o[q] = M.format()), c.timezone && "local" != c.timezone && (o[r] = c.timezone), 
                    K.pushLoading(), a.ajax(a.extend({}, uc, b, {
                        data: o,
                        success: function(b) {
                            b = b || [];
        ...
        function i(b) {
            var c, d, e = Pb.sourceNormalizers;
            if (a.isFunction(b) || a.isArray(b) ? c = {
                ...
                a.isArray(c.events) && (c.origArray = c.events, c.events = a.map(c.events, function(a) {
                    return s(a, c);
        ...
        function m(a) {
            a.start = K.moment(a.start), a.end ? a.end = K.moment(a.end) : a.end = null, x(a, n(a)), 
            N(T);
        }
        function n(b) {
            var c = {};
        ...
        function p(a, b) {
            var c, d, e, f = s(a);
            if (f) {
                for (c = w(f), d = 0; d < c.length; d++) e = c[d], e.source || (b && (O.events.push(e), 
                e.source = O), T.push(e));
                return N(T), c;
            }
            return [];
        ...
        function s(d, e) {
            ...
            a.extend(i, d), e && (i.source = e), i._id = d._id || (void 0 === d.id ? "_fc" + vc++ : d.id + ""), 
            d.className ? "string" == typeof d.className ? i.className = d.className.split(/\s+/) : i.className = d.className : i.className = [], 
            f = d.start || d.date, g = d.end, P(f) && (f = b.duration(f)), P(g) && (g = b.duration(g)), 
            d.dow || b.isDuration(f) || b.isDuration(g)) i.start = f ? b.duration(f) : null, 
            i.end = g ? b.duration(g) : null, i._recurring = !0; else {
                if (f && (f = K.moment(f), !f.isValid())) return !1;
                g && (g = K.moment(g), g.isValid() || (g = null)), h = d.allDay, void 0 === h && (h = X(e ? e.allDayDefault : void 0, c.allDayDefault)), 
                t(f, g, h, i);
            }
            return i;
        }
        function t(a, b, c, d) {
            d.start = a, d.end = b, d.allDay = c, u(d), Ob(d);
        }
        function u(a) {
        ...
        function v(a) {
            ...
            a.allDay ? (a.start.stripTime(), a.end && a.end.stripTime()) : (a.start.hasTime() || (a.start = K.applyTimezone(a.start.time(0))), 
            a.end && !a.end.hasTime() && (a.end = K.applyTimezone(a.end.time(0))));
        }
        function w(b, c, d) {
            var e, f, g, h, i, j, k, l, m, n = [];
            if (c = c || L, d = d || M, b) if (b._recurring) {
                if (f = b.dow) for (e = {}, g = 0; g < f.length; g++) e[f[g]] = !0;
                for (h = c.clone().stripTime(); h.isBefore(d); ) (!e || e[h.day()]) && (i = b.start, 
                j = b.end, k = h.clone(), l = null, i && (k = k.time(i)), j && (l = h.clone().time(j)), 
                m = a.extend({}, b), t(k, l, !i && !j, m), n.push(m)), h.add(1, "days");
            } else n.push(b);
            return n;
        }
        function x(b, c, d) {
            ...
            var f, g, h, i, j, k, l = {};
            return c = c || {}, c.start || (c.start = b.start.clone()), void 0 === c.end && (c.end = b.end ? b.end.clone() : null), 
            null == c.allDay && (c.allDay = b.allDay), u(c), f = {
                start: b._start.clone(),
                end: b._end ? b._end.clone() : K.getDefaultEventEnd(b._allDay, b._start),
                allDay: c.allDay
            }, u(f), g = null !== b._end && null === c.end, h = e(c.start, f.start), c.end ? (i = e(c.end, f.end), 
            j = i.subtract(h)) : j = null, a.each(c, function(a, b) {
                o(a) && void 0 !== b && (l[a] = b);
        ...
        function y(b, c, d, e, f, g) {
            ...
            return e && !e.valueOf() && (e = null), f && !f.valueOf() && (f = null), a.each(b, function(b, j) {
                ...
                k = {
                    ...
                    allDay: d
                }, u(l), c ? l.end = null : f && !l.end && (l.end = K.getDefaultEventEnd(l.allDay, l.start)), 
                e && (l.start.add(e), l.end && l.end.add(e)), f && l.end.add(f), h && !l.allDay && (e || f) && (l.start.stripZone(), 
                l.end && l.end.stripZone()), a.extend(j, g, l), Ob(j), i.push(function() {
                    a.extend(j, k), Ob(j);
                });
            }), function() {
        ...
        function z(b) {
            ...
            return e && (d = a.extend({}, f, "object" == typeof e ? e : {})), d ? (b && (d.start = null, 
            d.end = null), w(s(d), g.start, g.end)) : [];
        }
        function A(a, b) {
        ...
        var K = this;
        K.isFetchNeeded = d, K.fetchEvents = e, K.addEventSource = h, K.removeEventSource = j, 
        K.updateEvent = m, K.renderEvent = p, K.removeEvents = q, K.clientEvents = r, K.mutateEvent = x, 
        K.normalizeEventDates = u, K.normalizeEventTimes = v;
        var L, M, N = K.reportEvents, O = {
            events: []
        }, Q = [ O ], R = 0, S = 0, T = [];
        a.each((c.events ? [ c.events ] : []).concat(c.eventSources || []), function(a, b) {
            var c = i(b);
            c && Q.push(c);
        }), K.getBusinessHoursEvents = z, K.isEventSpanAllowed = A, K.isExternalSpanAllowed = B, 
        K.isSelectionSpanAllowed = C, K.getEventCache = function() {
            return T;
        };
    }
    function Ob(a) {
    ...
    a.fn.fullCalendar = function(b) {
        ...
        return this.each(function(e, f) {
            ...
            "string" == typeof b ? i && a.isFunction(i[b]) && (g = i[b].apply(i, c), e || (d = g), 
            "destroy" === b && h.removeData("fullCalendar")) : i || (i = new pc(h, b), h.data("fullCalendar", i), 
            i.render());
        }), d;
    };
    var Rb = [ "header", "buttonText", "buttonIcons", "themeButtonIcons" ];
    Pb.intersectRanges = E, Pb.applyAll = W, Pb.debounce = db, Pb.isInt = bb, Pb.htmlEscape = Y, 
    Pb.cssToStr = $, Pb.proxy = cb, Pb.capitaliseFirstLetter = _, Pb.getOuterRect = o, 
    Pb.getClientRect = p, Pb.getContentRect = q, Pb.getScrollbarWidths = r;
    var Sb = null;
    Pb.intersectRects = w, Pb.parseFieldSpecs = A, Pb.compareByFieldSpecs = B, Pb.compareByFieldSpec = C, 
    Pb.flexibleCompare = D, Pb.computeIntervalUnit = I, Pb.divideRangeByDuration = K, 
    Pb.divideDurationByDuration = L, Pb.multiplyDuration = M, Pb.durationHasTime = N;
    var Tb = [ "sun", "mon", "tue", "wed", "thu", "fri", "sat" ], Ub = [ "year", "month", "week", "day", "hour", "minute", "second", "millisecond" ];
    Pb.log = function() {
        var a = window.console;
        return a && a.log ? a.log.apply(a, arguments) : void 0;
    }, Pb.warn = function() {
        var a = window.console;
        return a && a.warn ? a.warn.apply(a, arguments) : Pb.log.apply(Pb, arguments);
    };
    var Vb, Wb, Xb, Yb = {}.hasOwnProperty, Zb = /^\s*\d{4}-\d\d$/, $b = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, _b = b.fn, ac = a.extend({}, _b);
    Pb.moment = function() {
        return eb(arguments);
    }, Pb.moment.utc = function() {
        var a = eb(arguments, !0);
        return a.hasTime() && a.utc(), a;
    }, Pb.moment.parseZone = function() {
        return eb(arguments, !0, !0);
    }, _b.clone = function() {
        var a = ac.clone.apply(this, arguments);
        return gb(this, a), this._fullCalendar && (a._fullCalendar = !0), a;
    }, _b.week = _b.weeks = function(a) {
        var b = (this._locale || this._lang)._fullCalendar_weekCalc;
        return null == a && "function" == typeof b ? b(this) : "ISO" === b ? ac.isoWeek.apply(this, arguments) : ac.week.apply(this, arguments);
    }, _b.time = function(a) {
        if (!this._fullCalendar) return ac.time.apply(this, arguments);
    ...
    }, _b.stripTime = function() {
        var a;
        return this._ambigTime || (a = this.toArray(), this.utc(), Wb(this, a.slice(0, 3)), 
        this._ambigTime = !0, this._ambigZone = !0), this;
    }, _b.hasTime = function() {
        return !this._ambigTime;
    }, _b.stripZone = function() {
        var a, b;
        return this._ambigZone || (a = this.toArray(), b = this._ambigTime, this.utc(), 
        Wb(this, a), this._ambigTime = b || !1, this._ambigZone = !0), this;
    }, _b.hasZone = function() {
        return !this._ambigZone;
    }, _b.local = function() {
        var a = this.toArray(), b = this._ambigZone;
        return ac.local.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, 
        b && Xb(this, a), this;
    }, _b.utc = function() {
        return ac.utc.apply(this, arguments), this._ambigTime = !1, this._ambigZone = !1, 
        this;
    }, a.each([ "zone", "utcOffset" ], function(a, b) {
        ac[b] && (_b[b] = function(a) {
            return null != a && (this._ambigTime = !1, this._ambigZone = !1), ac[b].apply(this, arguments);
        });
    }), _b.format = function() {
        return this._fullCalendar && arguments[0] ? jb(this, arguments[0]) : this._ambigTime ? ib(this, "YYYY-MM-DD") : this._ambigZone ? ib(this, "YYYY-MM-DD[T]HH:mm:ss") : ac.format.apply(this, arguments);
    }, _b.toISOString = function() {
        return this._ambigTime ? ib(this, "YYYY-MM-DD") : this._ambigZone ? ib(this, "YYYY-MM-DD[T]HH:mm:ss") : ac.toISOString.apply(this, arguments);
    }, _b.isWithin = function(a, b) {
        var c = fb([ this, a, b ]);
        return c[0] >= c[1] && c[0] < c[2];
    }, _b.isSame = function(a, b) {
        var c;
        return this._fullCalendar ? b ? (c = fb([ this, a ], !0), ac.isSame.call(c[0], c[1], b)) : (a = Pb.moment.parseZone(a), 
        ac.isSame.call(this, a) && Boolean(this._ambigTime) === Boolean(a._ambigTime) && Boolean(this._ambigZone) === Boolean(a._ambigZone)) : ac.isSame.apply(this, arguments);
    }, a.each([ "isBefore", "isAfter" ], function(a, b) {
        _b[b] = function(a, c) {
            var d;
            return this._fullCalendar ? (d = fb([ this, a ]), ac[b].call(d[0], d[1], c)) : ac[b].apply(this, arguments);
        };
    }), Vb = "_d" in b() && "updateOffset" in b, Wb = Vb ? function(a, c) {
        a._d.setTime(Date.UTC.apply(Date, c)), b.updateOffset(a, !1);
    } : hb, Xb = Vb ? function(a, c) {
        a._d.setTime(+new Date(c[0] || 0, c[1] || 0, c[2] || 0, c[3] || 0, c[4] || 0, c[5] || 0, c[6] || 0)), 
        b.updateOffset(a, !1);
    } : hb;
    var bc = {
        t: function(a) {
            return ib(a, "a").charAt(0);
        },
        T: function(a) {
            return ib(a, "A").charAt(0);
        }
    ...
    Pb.Class = rb, rb.extend = function() {
        var a, b, c = arguments.length;
        for (a = 0; c > a; a++) b = arguments[a], c - 1 > a && tb(this, b);
        return sb(this, b || {});
    }, rb.mixin = function(a) {
        tb(this, a);
    };
    var ec = Pb.Emitter = rb.extend({
        callbackHash: null,
        on: function(a, b) {
        ...
        getCallbacks: function(b) {
            var c;
            return this.callbackHash || (this.callbackHash = {}), c = this.callbackHash[b], 
            c || (c = this.callbackHash[b] = a.Callbacks()), c;
        }
    }), fc = rb.extend({
        isHidden: !0,
        options: null,
        ...
        render: function() {
            ...
            this.el = a('<div class="fc-popover"/>').addClass(c.className || "").css({
                ...
                b.hide();
            }), c.autoHide && a(document).on("mousedown", this.documentMousedownProxy = cb(this, "documentMousedown"));
        },
        ...
        position: function() {
            ...
            l.is(window) || l.is(document) ? (l = k, b = 0, c = 0) : (d = l.offset(), b = d.top, 
            c = d.left), b += k.scrollTop(), c += k.scrollLeft(), g.viewportConstrain !== !1 && (e = Math.min(e, b + l.outerHeight() - j - this.margin), 
            e = Math.max(e, b + this.margin), f = Math.min(f, c + l.outerWidth() - i - this.margin), 
        ...
        constructor: function(b) {
            this.els = a(b.els), this.isHorizontal = b.isHorizontal, this.isVertical = b.isVertical, 
            this.forcedOffsetParentEl = b.offsetParent ? a(b.offsetParent) : null;
        },
        build: function() {
            var a = this.forcedOffsetParentEl || this.els.eq(0).offsetParent();
            this.origin = a.offset(), this.boundingRect = this.queryBoundingRect(), this.isHorizontal && this.buildElHorizontals(), 
        ...
        startListening: function(b) {
            var c;
            this.isListening || (b && this.options.scroll && (c = n(a(b.target)), c.is(window) || c.is(document) || (this.scrollEl = c, 
            this.scrollHandlerProxy = db(cb(this, "scrollHandler"), 100), this.scrollEl.on("scroll", this.scrollHandlerProxy))), 
            a(document).on("mousemove", this.mousemoveProxy = cb(this, "mousemove")).on("mouseup", this.mouseupProxy = cb(this, "mouseup")).on("selectstart", this.preventDefault), 
            b ? (this.originX = b.pageX, this.originY = b.pageY) : (this.originX = 0, this.originY = 0), 
            this.isListening = !0, this.listenStart(b));
        },
        ...
        startDrag: function(a) {
            this.isListening || this.startListening(), this.isDragging || (this.isDragging = !0, 
            this.dragStart(a));
        },
        ...
        stopListening: function(b) {
            this.stopDrag(b), this.isListening && (this.scrollEl && (this.scrollEl.off("scroll", this.scrollHandlerProxy), 
            this.scrollHandlerProxy = null), a(document).off("mousemove", this.mousemoveProxy).off("mouseup", this.mouseupProxy).off("selectstart", this.preventDefault), 
        ...
        updateScroll: function(a) {
            ...
            g && (b = (f - (a.pageY - g.top)) / f, c = (f - (g.bottom - a.pageY)) / f, d = (f - (a.pageX - g.left)) / f, 
            e = (f - (g.right - a.pageX)) / f, b >= 0 && 1 >= b ? h = b * this.scrollSpeed * -1 : c >= 0 && 1 >= c && (h = c * this.scrollSpeed), 
            d >= 0 && 1 >= d ? i = d * this.scrollSpeed * -1 : e >= 0 && 1 >= e && (i = e * this.scrollSpeed)), 
            this.setScrollVel(h, i);
        },
        setScrollVel: function(a, b) {
            this.scrollTopVel = a, this.scrollLeftVel = b, this.constrainScrollVel(), !this.scrollTopVel && !this.scrollLeftVel || this.scrollIntervalId || (this.scrollIntervalId = setInterval(cb(this, "scrollIntervalFunc"), this.scrollIntervalMs));
        },
        ...
        scrollIntervalFunc: function() {
            ...
            this.scrollTopVel && a.scrollTop(a.scrollTop() + this.scrollTopVel * b), this.scrollLeftVel && a.scrollLeft(a.scrollLeft() + this.scrollLeftVel * b), 
            this.constrainScrollVel(), this.scrollTopVel || this.scrollLeftVel || this.stopScrolling();
        },
        ...
        constructor: function(a, b) {
            hc.call(this, b), this.component = a;
        },
        listenStart: function(a) {
            var b, c, d, e = this.subjectEl;
            hc.prototype.listenStart.apply(this, arguments), this.computeCoords(), a ? (c = {
                left: a.pageX,
                top: a.pageY
            }, d = c, e && (b = o(e), d = x(d, b)), this.origHit = this.queryHit(d.left, d.top), 
            e && this.options.subjectCenter && (this.origHit && (b = w(this.origHit, b) || b), 
            d = y(b)), this.coordAdjust = z(d, c)) : (this.origHit = null, this.coordAdjust = null);
        },
        ...
        dragStart: function(a) {
            var b;
            hc.prototype.dragStart.apply(this, arguments), b = this.queryHit(a.pageX, a.pageY), 
            b && this.hitOver(b);
        },
        drag: function(a, b, c) {
            var d;
            hc.prototype.drag.apply(this, arguments), d = this.queryHit(c.pageX, c.pageY), ub(d, this.hit) || (this.hit && this.hitOut(), 
            d && this.hitOver(d));
        },
        dragStop: function() {
            this.hitDone(), hc.prototype.dragStop.apply(this, arguments);
        },
        hitOver: function(a) {
            var b = ub(a, this.origHit);
        ...
        listenStop: function() {
            hc.prototype.listenStop.apply(this, arguments), this.origHit = null, this.hit = null, 
            this.component.releaseHits();
        },
        scrollStop: function() {
            hc.prototype.scrollStop.apply(this, arguments), this.computeCoords();
        },
        ...
        start: function(b) {
            this.isFollowing || (this.isFollowing = !0, this.mouseY0 = b.pageY, this.mouseX0 = b.pageX, 
            this.topDelta = 0, this.leftDelta = 0, this.isHidden || this.updatePosition(), a(document).on("mousemove", this.mousemoveProxy = cb(this, "mousemove")));
        },
        stop: function(b, c) {
            function d() {
            ...
            this.isFollowing && !this.isAnimating && (this.isFollowing = !1, a(document).off("mousemove", this.mousemoveProxy), 
            b && f && !this.isHidden ? (this.isAnimating = !0, this.el.animate({
                top: this.top0,
                left: this.left0
            }, {
                duration: f,
        ...
        updatePosition: function() {
            var a, b;
            this.getEl(), null === this.top0 && (this.sourceEl.width(), a = this.sourceEl.offset(), 
            b = this.el.offsetParent().offset(), this.top0 = a.top - b.top, this.left0 = a.left - b.left), 
            this.el.css({
        ...
        mousemove: function(a) {
            this.topDelta = a.pageY - this.mouseY0, this.leftDelta = a.pageX - this.mouseX0, 
        ...
        largeUnit: null,
        constructor: function(a) {
            this.view = a, this.isRTL = a.opt("isRTL"), this.elsByFill = {}, this.externalDragStartProxy = cb(this, "externalDragStart");
        },
        ...
        processRangeOptions: function() {
            ...
            a = c.opt("displayEventTime"), null == a && (a = this.computeDisplayEventTime()), 
            b = c.opt("displayEventEnd"), null == b && (b = this.computeDisplayEventEnd()), 
            this.displayEventTime = a, this.displayEventEnd = b;
        },
        ...
        dayMousedown: function(a) {
            var b, c, d = this, e = this.view, f = e.opt("selectable"), i = new ic(this, {
                scroll: e.opt("dragScroll"),
                dragStart: function() {
                    e.unselect();
                },
                hitOver: function(a, e, h) {
                    h && (b = e ? a : null, f && (c = d.computeSelection(d.getHitSpan(h), d.getHitSpan(a)), 
                ...
                listenStop: function(a) {
                    b && e.triggerDayClick(d.getHitSpan(b), d.getHitEl(b), a), c && e.reportSelection(c, a), 
                    h();
                }
            });
            i.mousedown(a);
        ...
        fabricateHelperEvent: function(a, b) {
            var c = b ? R(b.event) : {};
            return c.start = a.start.clone(), c.end = a.end ? a.end.clone() : null, c.allDay = null, 
            this.view.calendar.normalizeEventDates(c), c.className = (c.className || []).concat("fc-helper"), 
            b || (c.editable = !1), c;
        },
        ...
        getDayClasses: function(a) {
            var b = this.view, c = b.calendar.getNow().stripTime(), d = [ "fc-" + Tb[a.day()] ];
    ...
    kc.mixin({
        ...
        renderEvents: function(a) {
            var b, c = [], d = [];
            for (b = 0; b < a.length; b++) (wb(a[b]) ? c : d).push(a[b]);
        ...
        triggerSegMouseout: function(a, b) {
            b = b || {}, this.mousedOverSeg && (a = a || this.mousedOverSeg, this.mousedOverSeg = null, 
            this.view.trigger("eventMouseout", a.el[0], a.event, b));
        },
        segDragMousedown: function(a, b) {
            var c, d = this, e = this.view, f = e.calendar, i = a.el, j = a.event, k = new jc(a.el, {
                parentEl: e.el,
                ...
                hitOver: function(b, h, i) {
                    a.hit && (i = a.hit), c = d.computeEventDrop(i.component.getHitSpan(i), b.component.getHitSpan(b), j), 
                    c && !f.isEventSpanAllowed(d.eventToSpan(c), j) && (g(), c = null), c && e.renderDrag(c, a) ? k.hide() : k.show(), 
                    h && (c = null);
                },
                hitOut: function() {
        ...
        computeExternalDrop: function(a, b) {
            var c = this.view.calendar, d = {
                start: c.applyTimezone(a.start),
                end: null
            };
            return b.startTime && !d.start.hasTime() && d.start.time(b.startTime), b.duration && (d.end = d.start.clone().add(b.duration)), 
            c.isExternalSpanAllowed(this.eventToSpan(d), d, b.eventProps) ? d : null;
        },
        renderDrag: function(a, b) {},
        unrenderDrag: function() {},
        segResizeMousedown: function(a, b, c) {
            var d, e = this, f = this.view, i = f.calendar, j = a.el, k = a.event, l = i.getEventEnd(k), m = new ic(this, {
                distance: 5,
                ...
                hitOver: function(b, h, j) {
                    ...
                    d = c ? e.computeEventStartResize(m, n, k) : e.computeEventEndResize(m, n, k), d && (i.isEventSpanAllowed(e.eventToSpan(d), k) ? d.start.isSame(k.start) && d.end.isSame(l) && (d = null) : (g(), 
                    d = null)), d && (f.hideEvent(k), e.renderEventResize(d, a));
                },
                hitOut: function() {
                    d = null;
                },
        ...
        computeEventResize: function(a, b, c, d) {
            ...
            return e = {
                ...
                allDay: d.allDay
            }, e.allDay && N(h) && (e.allDay = !1, g.normalizeEventTimes(e)), e[a].add(h), e.start.isBefore(e.end) || (f = this.minResizeDuration || (d.allDay ? g.defaultAllDayEventDuration : g.defaultTimedEventDuration), 
        ...
        getEventTimeText: function(a, b, c) {
            return null == b && (b = this.eventTimeFormat), null == c && (c = this.displayEventEnd), 
        ...
        eventsToSegs: function(b, c) {
            ...
            return a.each(e, function(a, b) {
                ...
                if (xb(b[0])) for (g = d.invertRanges(g), e = 0; e < g.length; e++) d.generateEventSegs(g[e], b[0], c, f); else for (e = 0; e < g.length; e++) d.generateEventSegs(g[e], b[e], c, f);
            }), f;
        },
        ...
        generateEventSegs: function(a, b, c, d) {
            var e, f;
            for (this.transformEventSpan(a, b), e = c ? c(a) : this.spanToSegs(a), f = 0; f < e.length; f++) this.transformEventSeg(e[f], a, b), 
            d.push(e[f]);
        },
        ...
        invertRanges: function(a) {
            ...
            for (a.sort(Ab), b = 0; b < a.length; b++) c = a[b], c.start > h && g.push({
                start: h,
                end: c.start
            }), h = c.end;
            return f > h && g.push({
        ...
        sortEventSegs: function(a) {
            a.sort(cb(this, "compareEventSegs"));
        },
    ...
    var lc = Pb.DayTableMixin = {
        ...
        sliceRangeByRow: function(a) {
            ...
            for (b = 0; b < this.rowCnt; b++) c = b * g, d = c + g - 1, e = Math.max(i, c), 
            f = Math.min(j, d), e = Math.ceil(e), f = Math.floor(f), f >= e && k.push({
                row: b,
        ...
        sliceRangeByDay: function(a) {
            ...
            for (b = 0; b < this.rowCnt; b++) for (c = b * h, d = c + h - 1, e = c; d >= e; e++) f = Math.max(j, e), 
            g = Math.min(k, e), f = Math.ceil(f), g = Math.floor(g), g >= f && l.push({
                row: b,
        ...
        renderHeadDateCellHtml: function(a, b) {
            var c = this.view;
            return '<th class="fc-day-header ' + c.widgetHeaderClass + " fc-" + Tb[a.day()] + '"' + (b > 1 ? ' colspan="' + b + '"' : "") + ">" + Y(a.format(this.colHeadFormat)) + "</th>";
        },
        ...
        renderBgCellHtml: function(a) {
            var b = this.view, c = this.getDayClasses(a);
        ...
        renderDates: function(a) {
            ...
            for (this.el.html(g), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day"), 
            this.rowCoordCache = new gc({
                els: this.rowEls,
                isVertical: !0
            }), this.colCoordCache = new gc({
        ...
        renderNumberCellHtml: function(a) {
            var b;
            return this.view.dayNumbersVisible ? (b = this.getDayClasses(a), b.unshift("fc-day-number"), 
        ...
        spanToSegs: function(a) {
            ...
            for (b = 0; b < d.length; b++) c = d[b], this.isRTL ? (c.leftCol = this.daysPerRow - 1 - c.lastRowDayIndex, 
        ...
        renderDrag: function(a, b) {
            return this.renderHighlight(this.eventToSpan(a)), b && !b.el.closest(this.el).length ? (this.renderEventLocationHelper(a, b), 
            this.applyDragOpacity(this.helperEls), !0) : void 0;
        },
        unrenderDrag: function() {
        ...
        renderHelper: function(b, c) {
            ...
            f = this.renderFgSegEls(f), d = this.renderSegRows(f), this.rowEls.each(function(b, f) {
                ...
                i.css("top", g).find("table").append(d[b].tbodyEl), h.append(i), e.push(i[0]);
            }), this.helperEls = a(e);
        },
        unrenderHelper: function() {
        ...
        renderFill: function(b, c, d) {
            var e, f, g, h = [];
            for (c = this.renderFillSegEls(b, c), e = 0; e < c.length; e++) f = c[e], g = this.renderFillRow(b, f, d), 
            this.rowEls.eq(f.row).append(g), h.push(g[0]);
            return this.elsByFill[b] = a(h), c;
        },
        renderFillRow: function(b, c, d) {
            var e, f, g = this.colCnt, h = c.leftCol, i = c.rightCol + 1;
            return d = d || b.toLowerCase(), e = a('<div class="fc-' + d + '-skeleton"><table><tr/></table></div>'), 
            f = e.find("tr"), h > 0 && f.append('<td colspan="' + h + '"/>'), f.append(c.el.attr("colspan", i - h)), 
            g > i && f.append('<td colspan="' + (g - i) + '"/>'), this.bookendCells(f), e;
        }
    });
    mc.mixin({
        rowStructs: null,
        unrenderEvents: function() {
            this.removeSegPopover(), kc.prototype.unrenderEvents.apply(this, arguments);
        },
        getEventSegs: function() {
            return kc.prototype.getEventSegs.call(this).concat(this.popoverSegs || []);
        },
        renderBgSegs: function(b) {
            var c = a.grep(b, function(a) {
                return a.event.allDay;
            });
            return kc.prototype.renderBgSegs.call(this, c);
        },
        renderFgSegs: function(b) {
            var c;
            return b = this.renderFgSegEls(b), c = this.rowStructs = this.renderSegRows(b), 
        ...
        fgSegHtml: function(a, b) {
            ...
            return j.unshift("fc-day-grid-event", "fc-h-event"), a.isStart && (c = this.getEventTimeText(f), 
            c && (l = '<span class="fc-time">' + Y(c) + "</span>")), d = '<span class="fc-title">' + (Y(f.title || "") || "&nbsp;") + "</span>", 
        ...
        renderSegRow: function(b, c) {
            function d(b) {
                for (;b > g; ) k = (r[e - 1] || [])[g], k ? k.attr("rowspan", parseInt(k.attr("rowspan") || 1, 10) + 1) : (k = a("<td/>"), 
                h.append(k)), q[e][g] = k, r[e][g] = k, g++;
            }
            ...
            for (e = 0; n > e; e++) {
                if (f = m[e], g = 0, h = a("<tr/>"), p.push([]), q.push([]), r.push([]), f) for (i = 0; i < f.length; i++) {
                    for (j = f[i], d(j.leftCol), k = a('<td class="fc-event-container"/>').append(j.el), 
                    j.leftCol != j.rightCol ? k.attr("colspan", j.rightCol - j.leftCol + 1) : r[e][g] = k; g <= j.rightCol; ) q[e][g] = k, 
                    p[e][g] = j, g++;
                    h.append(k);
                }
        ...
        limitRows: function(a) {
            ...
            for (b = 0; b < d.length; b++) this.unlimitRow(b), c = a ? "number" == typeof a ? a : this.computeRowLevelLimit(b) : !1, 
        ...
        computeRowLevelLimit: function(b) {
            ...
            for (d = 0; d < i.length; d++) if (e = i.eq(d).removeClass("fc-limited"), f = 0, 
            e.find("> td > :first-child").each(c), e.position().top + f > h) return d;
            return !1;
        },
        limitRow: function(b, c) {
            function d(d) {
                for (;d > w; ) j = t.getCellSegs(b, w, c), j.length && (m = f[c - 1][w], s = t.renderMoreLink(b, w, j), 
                r = a("<div/>").append(s), m.append(r), v.push(r[0])), w++;
            }
            var e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t = this, u = this.rowStructs[b], v = [], w = 0;
            if (c && c < u.segLevels.length) {
                for (e = u.segLevels[c - 1], f = u.cellMatrix, g = u.tbodyEl.children().slice(c).addClass("fc-limited").get(), 
                h = 0; h < e.length; h++) {
                    for (i = e[h], d(i.leftCol), l = [], k = 0; w <= i.rightCol; ) j = this.getCellSegs(b, w, c), 
                    l.push(j), k += j.length, w++;
                    if (k) {
                        for (m = f[c - 1][i.leftCol], n = m.attr("rowspan") || 1, o = [], p = 0; p < l.length; p++) q = a('<td class="fc-more-cell"/>').attr("rowspan", n), 
                        j = l[p], s = this.renderMoreLink(b, i.leftCol + p, [ i ].concat(j)), r = a("<div/>").append(s), 
                        q.append(r), o.push(q[0]), v.push(q[0]);
        ...
        unlimitRow: function(a) {
            ...
            b.moreEls && (b.moreEls.remove(), b.moreEls = null), b.limitedEls && (b.limitedEls.removeClass("fc-limited"), 
            b.limitedEls = null);
        },
        ...
        showSegPopover: function(a, b, c, d) {
            ...
            this.segPopover = new fc(f), this.segPopover.show();
        },
        renderSegPopoverContent: function(b, c, d) {
            ...
            for (d = this.renderFgSegEls(d, !0), this.popoverSegs = d, e = 0; e < d.length; e++) this.prepareHits(), 
            d[e].hit = this.getCellHit(b, c), this.releaseHits(), j.append(d[e].el);
            return i;
        },
        resliceDaySegs: function(b, c) {
            var d = a.map(b, function(a) {
                return a.event;
            }), e = c.clone(), f = e.clone().add(1, "days"), g = {
                start: e,
                end: f
            };
        ...
        getCellSegs: function(a, b, c) {
            for (var d, e = this.rowStructs[a].segMatrix, f = c || 0, g = []; f < e.length; ) d = e[f][b], 
            d && g.push(d), f++;
            return g;
        }
    });
    var nc = Pb.TimeGrid = kc.extend(lc, {
        slotDuration: null,
        snapDuration: null,
        snapsPerSlot: null,
        minTime: null,
        ...
        constructor: function() {
            kc.apply(this, arguments), this.processOptions();
        },
        renderDates: function() {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatEls = this.el.find(".fc-slats tr"), 
            this.colCoordCache = new gc({
                els: this.colEls,
                isHorizontal: !0
            }), this.slatCoordCache = new gc({
                els: this.slatEls,
                isVertical: !0
            });
        },
        ...
        renderSlatRowHtml: function() {
            for (var a, c, d, e = this.view, f = this.isRTL, g = "", h = b.duration(+this.minTime); h < this.maxTime; ) a = this.start.clone().time(h), 
            c = bb(L(h, this.labelInterval)), d = '<td class="fc-axis fc-time ' + e.widgetContentClass + '" ' + e.axisStyleAttr() + ">" + (c ? "<span>" + Y(a.format(this.labelFormat)) + "</span>" : "") + "</td>", 
        ...
        processOptions: function() {
            ...
            e = b.duration(e), f = f ? b.duration(f) : e, this.slotDuration = e, this.snapDuration = f, 
            this.snapsPerSlot = e / f, this.minResizeDuration = f, this.minTime = b.duration(d.opt("minTime")), 
            this.maxTime = b.duration(d.opt("maxTime")), c = d.opt("slotLabelFormat"), a.isArray(c) && (c = c[c.length - 1]), 
            this.labelFormat = c || d.opt("axisFormat") || d.opt("smallTimeFormat"), c = d.opt("slotLabelInterval"), 
            this.labelInterval = c ? b.duration(c) : this.computeLabelInterval(e);
        },
        computeLabelInterval: function(a) {
            var c, d, e;
            for (c = Dc.length - 1; c >= 0; c--) if (d = b.duration(Dc[c]), e = L(d, a), bb(e) && e > 1) return d;
            return b.duration(a);
        },
        computeEventTimeFormat: function() {
        ...
        computeTimeTop: function(a) {
            ...
            return e = Math.max(0, e), e = Math.min(d, e), b = Math.floor(e), b = Math.min(b, d - 1), 
            c = e - b, this.slatCoordCache.getTopPosition(b) + this.slatCoordCache.getHeight(b) * c;
        },
        renderDrag: function(a, b) {
            return b ? (this.renderEventLocationHelper(a, b), this.applyDragOpacity(this.helperEl), 
            !0) : void this.renderHighlight(this.eventToSpan(a));
        },
        unrenderDrag: function() {
        ...
        renderHelper: function(b, c) {
            ...
            for (h = this.renderFgSegEls(h), d = this.renderSegTable(h), e = 0; e < h.length; e++) f = h[e], 
            c && c.col === f.col && (g = c.el, f.el.css({
                left: g.css("left"),
                right: g.css("right"),
        ...
        renderFill: function(b, c, d) {
            var e, f, g, h, i, j, k, l, m, n;
            if (c.length) {
                for (c = this.renderFillSegEls(b, c), e = this.groupSegCols(c), d = d || b.toLowerCase(), 
                f = a('<div class="fc-' + d + '-skeleton"><table><tr/></table></div>'), g = f.find("tr"), 
                h = 0; h < e.length; h++) if (i = e[h], j = a("<td/>").appendTo(g), i.length) for (k = a('<div class="fc-' + d + '-container"/>').appendTo(j), 
                l = this.getCellDate(0, h), m = 0; m < i.length; m++) n = i[m], k.append(n.el.css({
    ...
    nc.mixin({
        ...
        renderFgSegs: function(b) {
            return b = this.renderFgSegEls(b), this.el.append(this.eventSkeletonEl = a('<div class="fc-content-skeleton"/>').append(this.renderSegTable(b))), 
            b;
        },
        ...
        renderSegTable: function(b) {
            ...
            for (c = this.groupSegCols(b), this.computeSegVerticals(b), f = 0; f < c.length; f++) {
                for (g = c[f], this.placeSlotSegs(g), h = a('<div class="fc-event-container"/>'), 
                d = 0; d < g.length; d++) e = g[d], e.el.css(this.generateSegPositionCss(e)), e.bottom - e.top < 30 && e.el.addClass("fc-short"), 
                h.append(e.el);
        ...
        placeSlotSegs: function(a) {
            var b, c, d;
            if (this.sortEventSegs(a), b = Eb(a), Fb(b), c = b[0]) {
                for (d = 0; d < c.length; d++) Gb(c[d]);
                for (d = 0; d < c.length; d++) this.computeSlotSegCoords(c[d], 0, 0);
            }
        },
        computeSlotSegCoords: function(a, b, c) {
            var d, e = a.forwardSegs;
            if (void 0 === a.forwardCoord) for (e.length ? (this.sortForwardSlotSegs(e), this.computeSlotSegCoords(e[0], b + 1, c), 
            a.forwardCoord = e[0].backwardCoord) : a.forwardCoord = 1, a.backwardCoord = a.forwardCoord - (a.forwardCoord - c) / (b + 1), 
            d = 0; d < e.length; d++) this.computeSlotSegCoords(e[d], 0, a.forwardCoord);
        },
        ...
        computeSegVerticals: function(a) {
            var b, c;
            for (b = 0; b < a.length; b++) c = a[b], c.top = this.computeDateTop(c.start, c.start), 
        ...
        fgSegHtml: function(a, b) {
            ...
            return k.unshift("fc-time-grid-event", "fc-v-event"), f.isMultiDayEvent(g) ? (a.isStart || a.isEnd) && (c = this.getEventTimeText(a), 
            d = this.getEventTimeText(a, "LT"), e = this.getEventTimeText(a, null, !1)) : (c = this.getEventTimeText(g), 
            d = this.getEventTimeText(g, "LT"), e = this.getEventTimeText(g, null, !1)), '<a class="' + k.join(" ") + '"' + (g.url ? ' href="' + Y(g.url) + '"' : "") + (l ? ' style="' + l + '"' : "") + '><div class="fc-content">' + (c ? '<div class="fc-time" data-start="' + Y(e) + '" data-full="' + Y(d) + '"><span>' + Y(c) + "</span></div>" : "") + (g.title ? '<div class="fc-title">' + Y(g.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (j ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>";
        },
        generateSegPositionCss: function(a) {
            ...
            return d && (f = Math.min(1, e + 2 * (f - e))), this.isRTL ? (b = 1 - f, c = e) : (b = e, 
            c = 1 - f), g.zIndex = a.level + 1, g.left = 100 * b + "%", g.right = 100 * c + "%", 
            d && a.forwardPressure && (g[this.isRTL ? "marginLeft" : "marginRight"] = 20), g;
        },
        ...
        sortForwardSlotSegs: function(a) {
            a.sort(cb(this, "compareForwardSlotSegs"));
        },
    ...
    var oc = Pb.View = rb.extend({
        ...
        constructor: function(a, c, d, e) {
            this.calendar = a, this.type = this.name = c, this.options = d, this.intervalDuration = e || b.duration(1, "day"), 
            this.nextDayThreshold = b.duration(this.opt("nextDayThreshold")), this.initThemingProps(), 
            this.initHiddenDays(), this.isRTL = this.opt("isRTL"), this.eventOrderSpecs = A(this.opt("eventOrder")), 
            this.documentMousedownProxy = cb(this, "documentMousedown"), this.initialize();
        },
        initialize: function() {},
        opt: function(a) {
        ...
        computeRange: function(a) {
            ...
            return /year|month|week|day/.test(d) ? (e.stripTime(), f.stripTime()) : (e.hasTime() || (e = this.calendar.time(0)), 
            f.hasTime() || (f = this.calendar.time(0))), b = e.clone(), b = this.skipHiddenDays(b), 
            c = f.clone(), c = this.skipHiddenDays(c, -1, !0), {
                intervalUnit: d,
                intervalStart: e,
                intervalEnd: f,
                start: b,
        ...
        formatRange: function(a, b, c) {
            var d = a.end;
            return d.hasTime() || (d = d.clone().subtract(1)), mb(a.start, d, b, c, this.opt("isRTL"));
        },
        ...
        display: function(b) {
            var c = this, d = null;
            return this.displaying && (d = this.queryScroll()), this.calendar.freezeContentHeight(), 
        ...
        displayView: function(a) {
            ...
            a && this.setDate(a), this.render && this.render(), this.renderDates(), this.updateSize(), 
            this.renderBusinessHours();
        },
        clearView: function() {
            this.unselect(), this.triggerUnrender(), this.unrenderBusinessHours(), this.unrenderDates(), 
        ...
        initThemingProps: function() {
            ...
            this.widgetHeaderClass = a + "-widget-header", this.widgetContentClass = a + "-widget-content", 
        ...
        displayEvents: function(a) {
            ...
            this.clearEvents(), this.renderEvents(a), this.isEventsRendered = !0, this.setScroll(b), 
            this.triggerEventRender();
        },
        clearEvents: function() {
            this.isEventsRendered && (this.triggerEventUnrender(), this.destroyEvents && this.destroyEvents(), 
        ...
        unselect: function(a) {
            ...
            this.unrenderSelection(), this.trigger("unselect", null, a));
        },
        unrenderSelection: function() {},
        documentMousedown: function(b) {
            var c;
        ...
        initOptions: function(a) {
            var b, e, f, g;
            a = d(a), b = a.lang, e = qc[b], e || (b = pc.defaults.lang, e = qc[b] || {}), f = X(a.isRTL, e.isRTL, pc.defaults.isRTL), 
            g = f ? pc.rtlDefaults : {}, this.dirDefaults = g, this.langDefaults = e, this.overrides = a, 
            this.options = c([ pc.defaults, g, e, a ]), Kb(this.options), this.viewSpecCache = {};
        },
        ...
        getUnitViewSpec: function(b) {
            var c, d, e;
            if (-1 != a.inArray(b, Ub)) for (c = this.header.getViewsWithButtons(), a.each(Pb.views, function(a) {
                c.push(a);
            }), d = 0; d < c.length; d++) if (e = this.getViewSpec(c[d]), e && e.singleUnit == b) return e;
        },
        buildViewSpec: function(a) {
            for (var d, e, f, g, h = this.overrides.views || {}, i = [], j = [], k = [], l = a; l; ) d = Qb[l], 
            e = h[l], l = null, "function" == typeof d && (d = {
                "class": d
            }), d && (i.unshift(d), j.unshift(d.defaults || {}), f = f || d.duration, l = l || d.type), 
            e && (k.unshift(e), f = f || e.duration, l = l || e.type);
            return d = Q(i), d.type = a, d["class"] ? (f && (f = b.duration(f), f.valueOf() && (d.duration = f, 
            g = I(f), 1 === f.as(g) && (d.singleUnit = g, k.unshift(h[g] || {})))), d.defaults = c(j), 
            d.overrides = c(k), this.buildViewSpecOptions(d), this.buildViewSpecButtonText(d, a), 
            d) : !1;
        },
        buildViewSpecOptions: function(a) {
            a.options = c([ pc.defaults, a.defaults, this.dirDefaults, this.langDefaults, this.overrides, a.overrides ]), 
            Kb(a.options);
        },
        buildViewSpecButtonText: function(a, b) {
            ...
            a.buttonTextOverride = c(this.overrides) || a.overrides.buttonText, a.buttonTextDefault = c(this.langDefaults) || c(this.dirDefaults) || a.defaults.buttonText || c(pc.defaults) || (a.duration ? this.humanizeDuration(a.duration) : null) || b;
        },
    ...
    var qc = Pb.langs = {};
    Pb.datepickerLang = function(b, c, d) {
        var e = qc[b] || (qc[b] = {});
        e.isRTL = d.isRTL, e.weekNumberTitle = d.weekHeader, a.each(rc, function(a, b) {
            e[a] = b(d);
        }), a.datepicker && (a.datepicker.regional[c] = a.datepicker.regional[b] = d, a.datepicker.regional.en = a.datepicker.regional[""], 
        a.datepicker.setDefaults(d));
    }, Pb.lang = function(b, d) {
        var e, f;
        e = qc[b] || (qc[b] = {}), d && (e = qc[b] = c([ e, d ])), f = Lb(b), a.each(sc, function(a, b) {
            null == e[a] && (e[a] = b(f, e));
        }), pc.defaults.lang = b;
    };
    var rc = {
        ...
        dayOfMonthFormat: function(a, b) {
            ...
            return c = c.replace(/^Y+[^\w\s]*|[^\w\s]*Y+$/g, ""), b.isRTL ? c += " ddd" : c = "ddd " + c, 
            c;
        },
    ...
    Pb.lang("en", pc.englishDefaults), Pb.sourceNormalizers = [], Pb.sourceFetchers = [];
    var uc = {
        dataType: "json",
        cache: !1
    }, vc = 1;
    pc.prototype.getPeerEvents = function(a, b) {
        var c, d, e = this.getEventCache(), f = [];
        for (c = 0; c < e.length; c++) d = e[c], b && b._id === d._id || f.push(d);
        return f;
    };
    var wc = Pb.BasicView = oc.extend({
        dayGridClass: mc,
        dayGrid: null,
        dayNumbersVisible: !1,
        ...
        instantiateDayGrid: function() {
            var a = this.dayGridClass.extend(xc);
            return new a(this);
        },
        setRange: function(a) {
            oc.prototype.setRange.call(this, a), this.dayGrid.breakOnWeeks = /year|month|week/.test(this.intervalUnit), 
            this.dayGrid.setRange(a);
        },
        computeRange: function(a) {
            var b = oc.prototype.computeRange.call(this, a);
            return /year|month/.test(b.intervalUnit) && (b.start.startOf("week"), b.start = this.skipHiddenDays(b.start), 
            b.end.weekday() && (b.end.add(1, "week").startOf("week"), b.end = this.skipHiddenDays(b.end, -1, !0))), 
            b;
        },
        renderDates: function() {
            this.dayNumbersVisible = this.dayGrid.rowCnt > 1, this.weekNumbersVisible = this.opt("weekNumbers"), 
            this.dayGrid.numbersVisible = this.dayNumbersVisible || this.weekNumbersVisible, 
            this.el.addClass("fc-basic-view").html(this.renderSkeletonHtml()), this.renderHead(), 
            this.scrollerEl = this.el.find(".fc-day-grid-container"), this.dayGrid.setElement(this.el.find(".fc-day-grid")), 
        ...
        setHeight: function(a, b) {
            ...
            m(this.scrollerEl), f(this.headRowEl), this.dayGrid.removeSegPopover(), d && "number" == typeof d && this.dayGrid.limitRows(d), 
            c = this.computeScrollerHeight(a), this.setGridHeight(c, b), d && "number" != typeof d && this.dayGrid.limitRows(d), 
            !b && l(this.scrollerEl, c) && (e(this.headRowEl, r(this.scrollerEl)), c = this.computeScrollerHeight(a), 
    ...
    }, yc = Pb.MonthView = wc.extend({
        computeRange: function(a) {
            var b, c = wc.prototype.computeRange.call(this, a);
            return this.isFixedWeeks() && (b = Math.ceil(c.end.diff(c.start, "weeks", !0)), 
            c.end.add(6 - b, "weeks")), c;
        },
        setGridHeight: function(a, b) {
    ...
    var zc = Pb.AgendaView = oc.extend({
        timeGridClass: nc,
        timeGrid: null,
        dayGridClass: mc,
        dayGrid: null,
        ...
        instantiateTimeGrid: function() {
            var a = this.timeGridClass.extend(Ac);
            return new a(this);
        },
        instantiateDayGrid: function() {
            var a = this.dayGridClass.extend(Bc);
            return new a(this);
        },
        setRange: function(a) {
            oc.prototype.setRange.call(this, a), this.timeGrid.setRange(a), this.dayGrid && this.dayGrid.setRange(a);
        },
        renderDates: function() {
            this.el.addClass("fc-agenda-view").html(this.renderSkeletonHtml()), this.renderHead(), 
            this.scrollerEl = this.el.find(".fc-time-grid-container"), this.timeGrid.setElement(this.el.find(".fc-time-grid")), 
            this.timeGrid.renderDates(), this.bottomRuleEl = a('<hr class="fc-divider ' + this.widgetHeaderClass + '"/>').appendTo(this.timeGrid.el), 
        ...
        updateSize: function(a) {
            this.timeGrid.updateSize(a), oc.prototype.updateSize.call(this, a);
        },
        updateWidth: function() {
        ...
        setHeight: function(a, b) {
            ...
            this.bottomRuleEl.hide(), this.scrollerEl.css("overflow", ""), m(this.scrollerEl), 
            f(this.noScrollRowEls), this.dayGrid && (this.dayGrid.removeSegPopover(), c = this.opt("eventLimit"), 
            c && "number" != typeof c && (c = Cc), c && this.dayGrid.limitRows(c)), b || (d = this.computeScrollerHeight(a), 
            l(this.scrollerEl, d) ? (e(this.noScrollRowEls, r(this.scrollerEl)), d = this.computeScrollerHeight(a), 
        ...
        renderEvents: function(a) {
            ...
            b = this.timeGrid.renderEvents(e), this.dayGrid && (f = this.dayGrid.renderEvents(d)), 
            this.updateHeight();
        },
        getEventSegs: function() {
        ...
        renderHeadIntroHtml: function() {
            ...
            '<th class="fc-axis fc-week-number ' + b.widgetHeaderClass + '" ' + b.axisStyleAttr() + "><span>" + Y(a) + "</span></th>") : '<th class="fc-axis ' + b.widgetHeaderClass + '" ' + b.axisStyleAttr() + "></th>";
        },
        renderBgIntroHtml: function() {
            var a = this.view;
