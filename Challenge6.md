...
<li>Copy all the queries from <a href="https://github.com/VectorSense/Azure-AI-Ninja-Tech-Series/blob/master/DIY%20Demos/BotDB_Script.sql">sql script file</a></li>&nbsp;
