            ...
            namespace Speech
            {
                class IntentRecognitionSamples
                {
                    ...
                    public static async Task VoiceBasedAssistant()
                    {
                      ...
                      //  var Voiceconfig = SpeechConfig.FromSubscription("b3f8ff6e7d2848169cb1890fafe1cce4", "westus");
                        ...
                        {
                            // var config = SpeechConfig.FromSubscription("07d214a98657427c806517f48ac9f1ef", "westus");
                            ...
                            using (var recognizer = new IntentRecognizer(config))
                            {
                               ...
                               // var model = LanguageUnderstandingModel.FromAppId("a8e2e8dd-2d98-4f72-864f-2038af995b9c");
                                ...
                                recognizer.Recognized += (s, e) =>
                                {
                                    if (e.Result.Reason == ResultReason.RecognizedIntent)
                                    {
                                        ...
                                        String TextResult = "";
                                        if (Intent == "Greeting")
                                            TextResult = "Hello Srikar, Welcome back to Shopper's Heaven. Last time you have visited us on Jan 1st ,2019 for some new year offers. How can I help you today ?";
                                        else if (Intent == "DiscoverDealsForTheDay")
                                            TextResult = "Sure...Give me 2 mins.. We have got great offers for you today. Men and Kids Casual Wears having 40 % discount offers. Foot wear section had just launched 60 % clearance sale offer. And Formal Wear section is having personalized offer for you";
                                        else if (Intent == "DiscoverLocation")
                                            TextResult = "Please go till Gate 2 and take the elevator to second floor. You can find Men's casual wear section on your righthand side";
                                        else if (Intent == "HowToGoToTrialRoom")
                                            TextResult = "Trial room is just 200 metres away from you on your left hand side. But looks like all trial rooms are busy now. Please try after 10 mins";
                                            ...
                                            TextResult = "Its looks good Srikar. You will be 3rd person in the queue. Please proceed";
                                        else if (Intent == "GoodBye")
                                            TextResult = "Thanks Srikar for visiting us again. Hope you enjoyed shopping with me today. See you soon. Last but not least, please do not forget to give feedback about your experience at Shopper Heaven today at the link..";
                                        else
